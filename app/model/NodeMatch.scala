...
trait NodeMatchRepo  {
    ...
    def futureInsertNodeMatch(username: String, exerciseId: Int, sampleEntryId: Int, userEntryId: Int): Future[Int] =
        db.run(solutionEntryMatchesTQ += (username, exerciseId,sampleEntryId, userEntryId))
