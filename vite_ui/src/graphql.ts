...
export type ParagraphCitationAnnotationFragment = { sampleNodeId: number, userNodeId: number, awaitedParagraph: string, citedParagraph?: string | null, explanation?: string | null };
